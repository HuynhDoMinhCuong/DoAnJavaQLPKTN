...
public class FrmDangNhap extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lbHinhDangNhapTaiKhoan.setIcon(new javax.swing.ImageIcon("C:\\Users\\Huynh Cuong\\Desktop\\DoAnJavaQLPhongKhamTuNhan\\hinh\\iconUsers.png")); // NOI18N
    ...
    private void btnDangNhapTaiKhoanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDangNhapTaiKhoanActionPerformed
        if (!checkDangNhap())
       {
        ...
        try{
            ...
            if (dangnhap != null){
                JOptionPane.showMessageDialog(this, "Đăng nhập thành công! " + txtTaiKhoanDangNhap.getText());
            
                new FrmMenuChinh().setVisible(true); // Tìm thấy tên tài khoản và mật khẩu sẽ chuyển sang form Menu chính
                this.setVisible(false);
            }
            else {
                 JOptionPane.showMessageDialog(this, "Đăng nhập thất bại! " + txtTaiKhoanDangNhap.getText());
            }
        } catch (Exception ex){
